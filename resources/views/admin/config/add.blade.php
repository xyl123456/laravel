...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;添加配置项管理
</div>
<!--面包屑导航 结束-->
<!--结果集标题与导航组件 开始-->
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span><i class="fa fa-exclamation-circle yellow"></i>配置标题项必须填写</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span><i class="fa fa-exclamation-circle yellow"></i>配置名称必需填写</span>
                </td>
            </tr>
            <tr>
                <th>类型：</th>
            ...
            <tr class="field_value">
                ...
                <td>
                   <input type="text" class="lg" name="field_value">
                    <p><i class="fa fa-exclamation-circle yellow"></i>类型值只有在radio的情况下才需要配置，
                        格式 1|开启,0|关闭</p>
                </td>
            </tr>
            <tr>
