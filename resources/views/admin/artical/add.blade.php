...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;添加文章内容信息
</div>
<!--面包屑导航 结束-->
<!--结果集标题与导航组件 开始-->
...
<div class="result_wrap">
    <form action="{{url('admin/art')}}" method="post">
        {{csrf_field()}}
        <table class="add_tab">
            <tbody>
            <tr>
                <th width="60"><i class="require">*</i>文章分类：</th>
                <td>
                    <select name="cate_id">
                        @foreach($dates as $d)
            ...
            <tr>
                <th>编辑：</th>
                <td><input type="text" class="sm"  name="art_editor"></td>
            </tr>
            <tr>
                <th>文章缩略图片：</th>
                <td>
            ...
            <tr>
                <th></th>
                <td>
                    <img src="" alt="" id="art_thumb_img" style="max-width: 400px; max-height:100px;">
                </td>
            </tr>
            <tr>
                <th>文章关键词：</th>
