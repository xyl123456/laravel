...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;编辑文章内容
</div>
<!--面包屑导航 结束-->
<!--结果集标题与导航组件 开始-->
...
<div class="result_wrap">
    <form action="{{url('admin/art/'.$field->art_id)}}" method="post">
                    ...
                    <select name="art_pid">
                        ...
                        @foreach($data as $d)
                            <option value="{{$d->cate_id}}"
                                    @if($field->cate_id==$d->cate_pid) selected @endif
                            >{{$d->_cate_name}}</option>
                        @endforeach
                    </select>
                </td>
