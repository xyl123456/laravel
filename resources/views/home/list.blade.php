    ...
    <article class="blogs">
        ...
        <div class="newblog left">
            ...
            <ul class="nlist">
                ...
                <p class="dateview"><span>发布时间:{{date('Y-m-d',$d->art_time)}}</span><span>作者：{{$d->art_editor}}</span>
                    <span>分类：[<a href="{{url('cate/'.$field->cate_id)}}">{{$field->cate_name}}</a>]</span></p>
            <div class="line"></div>
            @endforeach
            <div class="page">
                {{$data->links()}}
